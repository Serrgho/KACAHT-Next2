...
Namespace Kas
    ...
    Public Module KasAntLoader
        ...
        Public Class KasantFetcher
            ...
            Public Sub ParseDangerOTS(doc As HtmlDocument, result As OtsData)
                ...
                Dim statusNode = doc.DocumentNode.SelectSingleNode("//td[@style[contains(.,'color: red')] and contains(., 'опасного')]")
       ...
       secondPart.Replace("«", "").Replace("»", ""), StringComparison.OrdinalIgnoreCase) Then
        ...
        Private Function GetDebugFolder() As String
            Dim desktopPath = Environment.GetFolderPath(Environment.SpecialFolder.Desktop)
            Dim debugFolder = System.IO.Path.Combine(desktopPath, "KasAntDebug")

            Try
                If Not System.IO.Directory.Exists(debugFolder) Then
    ...
    Public Class HistoryRecord
        ...
        Public Property AlienNum As String
        Public Property From As String
        Public Property ToDest As String
    ...
    Public Class LocoInfo
        ...
        Public Property RealNumber As String
        Public Property Depot As String
        Public Property Road As String
        Public Property CrewRoad As String
        Public Property CrewDepot As String
